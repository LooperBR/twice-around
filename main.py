...
grafo.addEdge("v1", "v2", 1)
grafo.addEdge("v1", "v3", 4)
grafo.addEdge("v1", "v4", 9)
grafo.addEdge("v1", "v5", 8)
grafo.addEdge("v1", "v6", 2)

grafo.addEdge("v2", "v3", 5)
grafo.addEdge("v2", "v4", 5)
grafo.addEdge("v2", "v5", 7)
grafo.addEdge("v2", "v6", 6)

grafo.addEdge("v3", "v4", 10)
grafo.addEdge("v3", "v5", 7)
grafo.addEdge("v3", "v6", 4)

grafo.addEdge("v4", "v5", 1)
grafo.addEdge("v4", "v6", 7)

grafo.addEdge("v5", "v6", 3)
